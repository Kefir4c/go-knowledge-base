...
Здесь максимальное количество теории, примеров и практических заданий.
...
1.5. Индексы на партиционированных таблицах:
  ...
  - Ограничение: нельзя создать уникальный индекс, если он не включает ключ партиционирования, потому что уникальность должна гарантироваться во всей таблице, а не в отдельной партиции.

1.6. FOREIGN KEY на партиционированных таблицах:
  - Можно создать FOREIGN KEY, ссылающийся на партиционированную таблицу.
  - Нельзя создать FOREIGN KEY, ссылающийся на отдельную партицию (только на родительскую).
